...
class Scoreboard():
    ...
    def __init__(self, ai_settings, screen, stats):
        ...
        #Font setting for scoreing info.
        self.text_color = (176,196,222)
    ...
    def prep_level(self):
        ...
        self.level_image = self.font.render( self.stats.lv, True, self.text_color, None)
    ...
    def prep_ships(self):
        ...
        for ship_number in range(self.stats.ships_left):
            ...
            ship.rect.x =ship_number * (ship.rect.width + 5)
            ship.rect.y = 10
            self.ships.add(ship)
